...
<body>
      ...
      <section id="articles"> <!-- A new section with the articles -->
            ...
            <article id="article1"> <!-- The new article tag. The id is supplied so it can be scrolled into view. -->
                <h3 class="style1">Set Course for Exam</h3>
                <div class="line"></div>
                ...
                <div class="articleBody clear">
					...
					<form action="after_admin_setexam.jsp" method="post" >
					  <table width="393" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td></td>        
                            <td><br>&nbsp;&nbsp; <input name="button1" type="reset" value="RESET" />&nbsp;&nbsp;&nbsp;&nbsp;<input name="button2" type="submit" value="SUBMIT" />					  </td>
                        </tr>
				      </table>
			        </form>
                </div></article>
