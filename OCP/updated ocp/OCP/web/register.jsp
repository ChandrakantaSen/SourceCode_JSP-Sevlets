            ...
            <section id="page"> <!-- Defining the #page section with the section tag -->
                ...
                <section id="articles"> <!-- A new section with the articles -->
                    ...
                    <article id="article1"> <!-- The new article tag. The id is supplied so it can be scrolled into view. -->
                        <h3 class="style1">New Registration</h3>
                        <div class="line"></div>

                        <div class="articleBody clear">
                            <figure> 
                                <div align="justify"><img src="img/register.jpg" width="570" height="300"></div>
                            </figure>
                            <!-- Editing is done here-->
                            <form name="f1" action="afterRegn.jsp" method="post" onsubmit="javascript:return validateForm();">
                            <%ResultSet rs = null;
                                Integer id1 = 0;
                                String s, id2 = null;%>
                            <%
                                ...
                                //out.print(s1+"  ");
                                s = "S";
                                s = s.concat(s1 + "_");//concat the string of s & current year. Like 'S2014_'
                                ocp.connect();
                                try {
                                    rs = ocp.view_STD_Table();
                                    while (rs.next()) {
                            ...
                            <table width="399" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <input type="checkbox" name="desig" value="student" required=""/></td>
                                    <td>Check this Box to Confirm as Student</td>
                                </tr>
                                <tr><td>&nbsp;</td></tr>
                                <tr>
                                    <td>&nbsp;</td>
