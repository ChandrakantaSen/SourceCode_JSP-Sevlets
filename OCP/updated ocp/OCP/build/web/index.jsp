        ...
        <section id="page"> <!-- Defining the #page section with the section tag -->
            ...
            <section id="articles"> <!-- A new section with the articles -->
                ...
                <article id="article1"> <!-- The new article tag. The id is supplied so it can be scrolled into view. -->
                    <h2 align="center">&nbsp;</h2>
                    <h2 align="center"><strong>Discover Yourself, </strong><strong>Motivate Yourself. </strong></h2>
                    <h2 align="center"><strong>Find your place in this Competitive World !!!</strong>                </h2>
                    <div class="line"></div>

                    <div class="articleBody clear">

                        <div align="justify"><img src="img/940x240_Classroom_7.jpg" width="920" height="300"></div>
